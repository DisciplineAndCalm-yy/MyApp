<template>
  <div class="container-fluid">
    <el-alert title="注意！上传的图片命名不能超过2048个字符，请尽量简洁图片命名方式！" type="warning" show-icon></el-alert>
    <div class="row"><!--目录区域-->
      <div class="col">
        <el-button-group>
    ...
    <div class="row"><!--图片文件夹区域-->
      <div class="col">
        <div v-for="(v, i) in prefixes " :key="i" :title="v" class="well pull-left"><!--每个图片文件夹-->
        ...
        <div v-for="v in imglist " :key="v.name" :title="v.url" class="well pull-left"><!--所有图片-->
          <div class="pull-left" style="width:32px; height:110px;">
          ...
          <div style="width:110px;" class="pull-right">
            ...
            <i v-else :class="matchType(v.url).style" @click="selected(v.url)">
    ...
    async putimg(e) {
      if (this.uploadimg) {
        try {
          ...
          await client.put(`${decodeURIComponent(this.dirlist)}${e.file.name}`, e.file);
        } catch (e) {
